    ...
    private class MyFragmentPagerAdapter internal constructor(context: Context, fm: FragmentManager) : FragmentPagerAdapter(fm) {
        ...
        override fun getItem(position: Int): Fragment = when (position) {
            0 -> SocialFragment.Builder()
                    ...
                    .setContactEmailAddress("swordofverity@gmail.com")
//                    .setGithubProject("saschpe/PlanningPoker")
                    .setTwitterProfile("swordofverity")
                    // Visual customization
                    .setHeaderTextColor(R.color.accent)
                    .setIconTint(android.R.color.white)
                    .build()
            else -> SocialFragment.Builder().setApplicationId(BuildConfig.APPLICATION_ID).setApplicationName(applicationName).setContactEmailAddress("swordofverity@gmail.com")/*.setGithubProject("saschpe/PlanningPoker")*/.setTwitterProfile("swordofverity").setHeaderTextColor(R.color.accent).setIconTint(android.R.color.white).build()
        }
